    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            /// <summary>
            /// <param name = "an object of NFAtoDFA class"></param>
            /// <returns> The output will be the number of states of returned DFA </returns>
            /// </summary>
            ...
            */
            ...
            /// <summary>
            /// <param name = "NFA"> In this part I check the class in createEquivalentDFA.cs </param>
            /// <returns> The output will be the number of states of returned DFA </returns>
            /// </summary>

            var newNFA = creation.createNFA();
            System.Console.WriteLine(newNFA.createEquivalentDFA());
        }
    }
}